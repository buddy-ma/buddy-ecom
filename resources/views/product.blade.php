...
@section('content')
@php
    $trimmed = trim($data['product']->image, ".png|.png|.jpeg");
    $real_filename = $data['product']->image;
    $newFileName = substr($real_filename, 0 , (strrpos($real_filename, ".")));
    $pos = strpos($real_filename, "png");
    if($pos==True)
        $extension="png";
    $extension="jpeg";
    $real_price = round($data['product']->price, 2);
    $old_price = round($data['product']->price, 2) + 50;
@endphp
    ...
    <section class="agency breadcrumb-section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h2 class="breadcrumb-text text-center">{{ $data['product']->name }}</h2>
    ...
    <section>
        <div class="collection-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col-sm-3 collection-filter order-lg-2">
                        <div class="collection-filter-block">
                            <div class="collection-mobile-back">
                                <span class="filter-back"><i aria-hidden="true" class="fa fa-angle-left"></i>back</span>
                            </div>
                        ...
                        <div class="collection-filter-block">
                            <div class="product-service p-b-0">
                                <div class="media">
                                    <svg viewBox="0 -117 679.99892 679" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="media">
                                    <svg height="512px" id="Capa_1"
                                        style="enable-background:new 0 0 480 480;" version="1.1" viewBox="0 0 480 480" width="512px" x="0px"
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p>new online festival offer</p>
                                    </div>
                                </div>
                                <div class="media border-0 m-0">
                                    <svg height="512px" id="Layer_1"
                                        style="enable-background:new 0 0 512 512;" version="1.1" viewBox="0 0 512 512" width="512px" x="0px"
                                        xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        y="0px">
                                            <g>
                                                <g>
                    ...
                    <div class="col-lg-9 col-sm-12 col-xs-12">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="filter-main-btn mb-2">
                                        <span class="filter-btn"><i aria-hidden="true" class="fa fa-filter"></i> filter</span>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="product-slick">
                                            @foreach ($data['images'] as $img)
                                                @php
                                                    $trimmed = trim($img->image, ".png|.png|.jpeg");
                                                    $filename = $img->image;
                                                        ...
                                                        @foreach ($data['images'] as $img)
                                                            ...
                                                            <div>
                                                                <img alt="" class="img-fluid image_zoom_cls-0"
                                                                    src="https://www.ariba.ma/image/{{ $filename }}">
                                                            </div>
                                                        @endforeach
                                    ...
                                    <div class="product-right">
                                        ...
                                        <div class="product-description border-product">
                                            <h6 class="product-title size-text">select size
                                                <span><a data-bs-target="#sizemodal" data-bs-toggle="modal" href="">size chart</a></span>
                                            </h6>
                                            <div aria-hidden="true" aria-labelledby="exampleModalLabel" class="modal fade" id="sizemodal"
                                            ...
                                            <div class="qty-box">
                                                <div class="input-group">
                                                    <span class="input-group-prepend">
                                                        <button class="btn quantity-left-minus" data-field=""
                                                    ...
                                                    <input class="form-control input-number" name="quantity" type="text"
                                                        value="1">
                                                    <span class="input-group-prepend">
                                                        <button class="btn quantity-right-plus" data-field=""
                                        ...
                                        <div class="product-buttons">
                                            <a class="btn btn-default primary-btn radius-0" data-bs-target="#addtocart" data-bs-toggle="modal"
                                            href="#">add to cart</a>
                                            <a class="btn btn-default primary-btn radius-0" href="#">buy now</a>
                                        </div>
                                        <form class="d-inline-block">
                                            <button class="wishlist-btn" style="border:none; background:none; margin-bottom: 10px">
                        ...
                        <section class="tab-product p-0 mt-5">
                            <div class="row">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="tab-box">
                                    <ul class="nav nav-tabs nav-material" id="top-tab" role="tablist">
                                        <li class="nav-item">
                                            <a aria-selected="true" class="nav-link active" data-bs-toggle="tab" href="#top-home"
                                            id="top-home-tab" role="tab">
                                                <i class="icofont icofont-ui-home"></i>Description
                                            </a>
                                            <div class="material-border"></div>
                                        </li>
                                        <li class="nav-item">
                                            <a aria-selected="false" class="nav-link" data-bs-toggle="tab" href="#top-profile"
                                        ...
                                        <li class="nav-item">
                                            <a aria-selected="false" class="nav-link" data-bs-toggle="tab" href="#top-review"
                                            id="review-top-tab" role="tab">
                                    ...
                                    <div class="tab-content nav-material" id="top-tabContent">
                                        <div aria-labelledby="top-home-tab" class="tab-pane fade show active" id="top-home"
                                            role="tabpanel">
                                            <p class="p-b-0">
                                                {{ $data['products']->description ?? 'Lorem Ipsum is simply dummy text of the printing and
                                        ...
                                        <div aria-labelledby="profile-top-tab" class="tab-pane fade" id="top-profile"
                                            role="tabpanel">
                                            <p>
                                        ...
                                        <div aria-labelledby="contact-top-tab" class="tab-pane fade" id="top-contact"
                                            role="tabpanel">
                                        ...
                                        <div aria-labelledby="review-top-tab" class="tab-pane fade" id="top-review"
                                            role="tabpanel">
